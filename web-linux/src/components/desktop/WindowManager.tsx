...
const componentMap: Record<string, () => Promise<{ default: React.ComponentType<any> }>> = {
  ...
  SnippetForge: () => import('../../apps/SnippetForge'),
  ...
  AIWorkspace: () => import('../../apps/AIWorkspace'),
  AIRewriter: () => import('../../apps/AIRewriter'),
  ...
  CodePerfAnalyzer: () => import('../../apps/CodePerfAnalyzer'),
  ...
  CollaborationEnhanced: () => import('../../apps/CollaborationEnhanced'),
  ...
  SystemTaskManager: () => import('../../apps/SystemTaskManager'),
  SnippetManager: () => import('../../apps/SnippetManager'),
  SnippetShare: () => import('../../apps/SnippetShare'),
  ...
  RealtimeWhiteboard: () => import('../../apps/RealtimeWhiteboard'),
  ...
  BackgroundRemover: () => import('../../apps/BackgroundRemover'),
  CodeSnippetManager: () => import('../../apps/CodeSnippetManager'),
  ...
  VoiceAssistant: () => import('../../apps/VoiceAssistant'),
  ...
  WebContentExtractor: () => import('../../apps/WebContentExtractor'),
  ...
  AIDocGenerator: () => import('../../apps/AIDocGenerator'),
