...
export const appRegistry: AppDefinition[] = [
  ...
  { id: 'simple-password-manager', name: '简洁密码管理器', icon: <LockIcon />, component: 'PasswordManager', category: 'utilities', defaultWidth: 650, defaultHeight: 500, minWidth: 450, minHeight: 350, resizable: true, multiple: false },
