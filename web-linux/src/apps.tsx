...
export const APP_REGISTRY_EXTRAS: AppDefinition[] = [
  // === v144 新增创新工具 ===
  { id: 'clipboard-history', name: '剪贴板历史管理器', icon: <ClipboardIcon />, component: 'ClipboardHistory', category: 'utilities', defaultWidth: 700, defaultHeight: 600, minWidth: 500, minHeight: 400, resizable: true, multiple: false, isNew: true, description: '智能剪贴板历史管理：自动追踪复制内容、智能类型识别(文本/链接/代码/JSON)、搜索过滤、固定常用条目、一键复制' },
  { id: 'color-toolkit', name: '颜色工具箱', icon: <PaletteIcon />, component: 'ColorToolkit', category: 'development', defaultWidth: 1100, defaultHeight: 780, minWidth: 800, minHeight: 580, resizable: true, multiple: false, isNew: true, description: '全功能颜色工具箱：调色板生成、HEX/RGB/HSL互转、WCAG对比度检查、拾色器、CSS变量导出、渐变生成器' },
  { id: 'screen-ruler', name: '屏幕标尺', icon: <GridIcon />, component: 'ScreenRuler', category: 'utilities', defaultWidth: 900, defaultHeight: 680, minWidth: 600, minHeight: 480, resizable: true, multiple: false, isNew: true, description: '精确屏幕标尺工具：像素级距离/角度测量、网格叠加、放大镜、颜色拾取、辅助线、多单位切换(px/cm/mm)' },
  // === v145 新增创新工具 ===
  { id: 'json-query-tool', name: 'JSON Query 查询工具', icon: <FileJsonIcon />, component: 'JsonQueryTool', category: 'development', defaultWidth: 1200, defaultHeight: 800, minWidth: 900, minHeight: 600, resizable: true, multiple: false, isNew: true, description: '类 jq 的 JSON 数据查询工具：支持 JSONPath 语法（$.key, $[0], $.arr[*], 过滤表达式）、预设查询模板、分栏编辑与结果展示、一键复制' },
  // === v146 新增创新工具 ===
  { id: 'web-performance-insights', name: 'Web Performance Insights', icon: <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>, component: 'WebPerformanceInsights', category: 'development', defaultWidth: 1320, defaultHeight: 900, minWidth: 960, minHeight: 680, resizable: true, multiple: false, isNew: true, description: '基于真实浏览器API的性能仪表盘：Navigation Timing瀑布图、Core Web Vitals(LCP/CLS/FID)、资源加载分析、内存使用监控、长任务检测、性能评分(0-100)、4个分析视图' },
  { id: 'network-connectivity-checker', name: 'Network Connectivity Checker', icon: <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>, component: 'NetworkConnectivityChecker', category: 'networking', defaultWidth: 1200, defaultHeight: 800, minWidth: 900, minHeight: 600, resizable: true, multiple: false, isNew: true, description: '真实网络连通性检查器：测试16+热门服务(CDN/API/DNS/Social)的可达性、延迟、HTTP状态码，支持分类筛选、搜索过滤、单独/批量检测' },
  // === v142 新增实用工具 ===
  ...
  // === v140 新增实用工具
  { id: 'unit-converter', name: 'UnitConverter 单位转换器', icon: <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M5 8l6 6"/><path d="M4 14l6-6 2-3"/><path d="M2 5h12"/><path d="M7 2h1"/><path d="m22 22-5-10-5 10"/><path d="M14 18h6"/></svg>, component: 'UnitConverter', category: 'utilities', defaultWidth: 800, defaultHeight: 650, minWidth: 600, minHeight: 500, resizable: true, multiple: false, isNew: true, description: '全功能单位转换器：长度/重量/温度/速度/数据/时间/面积7大类别，双向转换，常用快捷按钮，历史记录' },
  { id: 'qr-code-generator', name: 'QRCodeGenerator 二维码生成器', icon: <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="8" height="8" rx="1"/><rect x="14" y="2" width="8" height="8" rx="1"/><rect x="2" y="14" width="8" height="8" rx="1"/><rect x="14" y="14" width="4" height="4"/><rect x="20" y="14" width="2" height="2"/><rect x="14" y="20" width="2" height="2"/><rect x="20" y="20" width="2" height="2"/></svg>, component: 'QRCodeGenerator', category: 'utilities', defaultWidth: 800, defaultHeight: 700, minWidth: 600, minHeight: 550, resizable: true, multiple: false, isNew: true, description: '纯前端QR码生成器：完整QR编码算法（Reed-Solomon纠错），4级纠错，自定义颜色/尺寸/样式，WiFi/vCard/邮件模板，下载PNG' },
  { id: 'json-to-typescript', name: 'JsonToTypeScript JSON转TS类型', icon: <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>, component: 'JsonToTypeScript', category: 'development', defaultWidth: 1100, defaultHeight: 750, minWidth: 800, minHeight: 550, resizable: true, multiple: false, isNew: true, description: 'JSON转TypeScript类型定义：智能类型推断，支持interface/type模式，可选属性检测，拖拽分栏，示例数据，下载.ts文件' },
  { id: 'markdown-cheat-sheet', name: 'MarkdownCheatSheet Markdown速查', icon: <CodeIcon />, component: 'MarkdownCheatSheet', category: 'development', defaultWidth: 1200, defaultHeight: 800, minWidth: 900, minHeight: 600, resizable: true, multiple: false, isNew: true, description: '交互式Markdown速查表：11个语法分类，实时预览编辑器，点击插入语法片段，多种分栏模式，导出HTML' },
