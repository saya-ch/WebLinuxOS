...
export const APP_REGISTRY_EXTRAS: AppDefinition[] = [
  ...
  { id: 'markdown-slides-pro', name: 'Markdown 演示文稿', icon: <PresentationIcon />, component: 'MarkdownSlidesPro', category: 'office', defaultWidth: 1200, defaultHeight: 800, minWidth: 900, minHeight: 600, resizable: true, multiple: false,  description: 'Markdown转演示文稿：实时编辑预览、幻灯片播放、全屏演示、导出HTML、过渡动画' },
  ...
  { id: 'weather-dashboard', name: '天气仪表板', icon: <CloudLucide />, component: 'WeatherDashboard', category: 'networking', defaultWidth: 900, defaultHeight: 750, minWidth: 700, minHeight: 550, resizable: true, multiple: false,  description: '精美天气仪表板：全球城市搜索、7日预报、逐时温度图表、收藏位置、Open-Meteo 免费API' },
  ...
  { id: 'weather-now', name: '天气实时预报', icon: <CloudRainIcon />, component: 'WeatherNow', category: 'internet', defaultWidth: 1200, defaultHeight: 820, minWidth: 900, minHeight: 640, resizable: true, multiple: false,  description: '基于 Open-Meteo API 的真实天气预报：城市搜索、7日预报、温湿度/风速/降水量数据、收藏城市、摄氏度/华氏度切换' },
  ...
  // === v69 创新应用套件 ===
  { id: 'focus-flow', name: 'FocusFlow 专注流', icon: <PomodoroIcon />, component: 'FocusFlow', category: 'utilities', defaultWidth: 520, defaultHeight: 680, minWidth: 460, minHeight: 600, resizable: true, multiple: false,  description: '深度工作计时器：番茄工作法、专注/休息模式切换、统计追踪、连续打卡、声音提醒、通知推送' },
