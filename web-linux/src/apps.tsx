...
export const APP_REGISTRY_EXTRAS: AppDefinition[] = [
  ...
  { id: 'linux-command-lab', name: 'Linux命令实验室', icon: <TerminalIcon />, component: 'LinuxCommandLab', category: 'development', defaultWidth: 1280, defaultHeight: 860, minWidth: 960, minHeight: 640, resizable: true, multiple: false, isNew: true, description: '交互式 Linux 命令模拟环境：30+ 常用命令、虚拟文件系统、命令历史与补全、终端风格界面、文件操作模拟' },
  { id: 'smart-shell', name: 'SmartShell 智能Shell', icon: <SparklesIcon />, component: 'SmartShell', category: 'development', defaultWidth: 1200, defaultHeight: 820, minWidth: 900, minHeight: 640, resizable: true, multiple: false, isNew: true, description: '自然语言转Shell命令智能翻译器：100+命令模式、13个分类过滤、命令收藏、历史记录、终端风格玻璃拟态UI' },
  { id: 'algorithm-visualizer', name: '算法可视化', icon: <BarChart3Icon />, component: 'AlgorithmVisualizer', category: 'development', defaultWidth: 1280, defaultHeight: 880, minWidth: 960, minHeight: 640, resizable: true, multiple: false, isNew: true, description: '交互式算法可视化工具：排序/搜索/图遍历/路径查找/数据结构，逐步执行动画、伪代码高亮、统计分析' },
  ...
  // === v89 创新应用套件 ===
  { id: 'md-html-generator', name: 'Markdown转HTML生成器', icon: <CodeIcon />, component: 'MarkdownToHTML', category: 'office', defaultWidth: 1280, defaultHeight: 860, minWidth: 960, minHeight: 640, resizable: true, multiple: false, isNew: true, description: 'Markdown转独立HTML生成器：5种精美主题模板、实时预览、代码高亮、数学公式、Mermaid图表、导出完整HTML文件（带样式）' },
