import {
  ...
  VoiceIcon, GraduationCapIcon, WrenchIcon, CpuIcon, SparklesIcon, ApiLabIcon
} from './icons'
...
export const appRegistry: AppDefinition[] = [
  ...
  { id: 'code-snippet-share', name: '代码片段分享', icon: <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/><rect x="10" y="8" width="4" height="8" rx="1"/></svg>, component: 'CodeSnippetShare', category: 'development', defaultWidth: 1200, defaultHeight: 850, minWidth: 850, minHeight: 600, resizable: true, multiple: false },
